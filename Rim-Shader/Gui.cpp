...
void Gui::update(bool& useTexture, bool& wireFrame, bool& backFaceCull, bool& drawNormal,
	...
	bool& usePerspective, Material& material, Light& light, Rim& rim) 
{
	...
	ImGui::Text("Rim");
	ImGui::SliderFloat3("Rim Color", &rim.rimColor[0], 0.0f, 1.0f);
	ImGui::SliderFloat("Rim Strength", &rim.rimStrength, 0.0f, 10.0f);
	ImGui::SliderFloat("Rim Power", &rim.rimPower, 0.0f, 10.0f);
	ImGui::Checkbox("Use Smoothstep", &rim.useSmoothstep);
	...
	ImGui::SliderFloat("Specular", &material.specular, 0.0f, 2.0f);
